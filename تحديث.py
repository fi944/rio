...
from telethon import HEROKU_APP, UPSTREAM_REPO_URL, events
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "** ᯽︙ تم تحديث سورس بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, "**᯽︙ يـتـم البـحـث عـن تـحديثـات سـورس انـتـظـر**")
    ...
    if conf == "الان":
        await event.edit("** ᯽︙ جار تحـديـث سـورس انـتـظـر قـليـلا 🔨**")
